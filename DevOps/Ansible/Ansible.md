...
- Выполняет каждую задачу, используя соответствующие [[Ansible#^642874|модули]] и передавая инструкции целевым узлам.
...
- Узлы выполняют [[Ansible#^38c3f2|задачи]] и возвращают результат обратно на [[Ansible#^7cdc7f|контроллер]], который агрегирует данные и отображает результат выполнения для пользователя.
